...
#if (TINY_REGEX_CONFIG_OR_ENABLE == 1) && (TINY_REGEX_CONFIG_SLICE_NUM > 0)
    pat_size_t pos_subpat[TINY_REGEX_CONFIG_SLICE_NUM+1]={0};
    pat_size_t num_subpat = 0;
#endif
    uint8_t curlevel = 0, misscount = 0, checkmode = TR_MODE_NULL,precheckmode = TR_MODE_NULL;
